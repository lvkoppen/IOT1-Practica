...
const eventHubsCompatibleEndpoint = "sb://iothub-ns-delftiothu-8528485-c734b6e251.servicebus.windows.net/";

// Event Hub-compatible name
// az iot hub show --query properties.eventHubEndpoints.events.path --name {your IoT Hub name}
const eventHubsCompatiblePath = "delftiothubpracticum2021";

// Primary key for the "service" policy to read messages
// az iot hub policy show --name service --query primaryKey --hub-name {your IoT Hub name}
const iotHubSasKey = "7c3SGtU21s8fUjcSGMMjXsO5sebBaPu2ix9Zg1Pj/I4=";
...
async function main() {
  ...
  const consumerClient = new EventHubConsumerClient(1, connectionString, clientOptions);
